...
public class SimpleDayhoffDistance extends SimpleDistance {

    public SimpleDayhoffDistance () {
	super();
    }
	...
	Dayhoff jtt = new Dayhoff(Dayhoff.getOriginalFrequencies());
	...
	// of Dayhoff into SubstitutionModel
	...
	SimpleDayhoffDistance d = new SimpleDayhoffDistance ();
	System.out.println ("distance is: |" + d.getDistance(xs, ys, new boolean[x.length()]) + "|");
    }

    // yes this works
    public static void test2() {
	double[] f = Dayhoff.getOriginalFrequencies();
