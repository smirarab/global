/**
 * Implements distance interface for pairwise gap omit Dayhoff distance.
 *
 */

public class PairwiseGapOmitDayhoffDistance extends PairwiseGapOmitDistance {
	...
	PairwiseGapOmitDayhoffDistance d = new PairwiseGapOmitDayhoffDistance ();
